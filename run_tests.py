...
def main():
    ...
    try:
        try:
            ...
            keys_dir = tempfile.mkdtemp("psi_tests_keyzcar_rsa_dir")
            ...
            pub_dir = tempfile.mkdtemp("psi_tests_keyzcar_pub_dir")
        ...
        settings.configure(
            ...
            MEDIA_ROOT='/tmp/psi_test_media/',
            MEDIA_PATH='/media/',
            ROOT_URLCONF='psi.tests.urls',
            DEBUG=True,
            TEMPLATE_DEBUG=True,
        ...
        if django.VERSION[:2] >= (1, 6):
            apps.append('psi.tests.testapp')
            apps.append('psi.tests')
